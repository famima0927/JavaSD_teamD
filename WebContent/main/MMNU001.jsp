	    ...
	    <!-- メイン -->
		   <div class="col-md-10 py-4" style="margin-bottom: 18rem;"">
		      ...
		      <div class="d-flex gap-4 justify-content-start">
		        <!-- 学生管理 -->
		        <div class="card shadow-sm border-0" style="width: 200px; height: 120px; background-color: #eacaca;">
		  ...
		  <div class="card-body d-flex flex-column align-items-center justify-content-center">
		    ...
		    <a href="${pageContext.request.contextPath}/servlet/TestListController"
		      ...
		      成績参照
		        ...
		        <!-- 科目管理 -->
		        <div class="card shadow-sm border-0" style="width: 200px; height: 120px; background-color: #cfcfe7;">
		          <div class="card-body d-flex align-items-center justify-content-center">
